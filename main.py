...
if __name__ == "__main__":
    ...
    # data_processing_2lvl_parallel(updated_values_set, WORKING_LINKS_2LVL, URL, 10)

    # Получаем ссылки третьего уровня
    data_processing_3lvl_parallel(updated_values_set, WORKING_LINKS_2LVL, WORKING_LINKS_3LVL, 10)
